...
def hotels(config):
    ...
    if stat != None :
        cursor.execute(("update rooms set status = 'yes' where roomid = '%s' ;") % stat )
        db.commit()
...
def home():
    ...
    <body background="hotel12.jpg">
        ...
        <div class = "animated fadeIn">
            <h1 name ="heading" class="hd" id="tre"> Check out </h1>
            <a href = "slide1.py" style="float:left"><button><-- Back</button></a>
        <br/><br/></div>
        <form action ="slide8.py" method="get">
        <div class ="animated fadeIn">
            <select name="hotels">
